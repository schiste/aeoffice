...
// Authored content: story beats + dialogue choices (quests/dialogue source of
// truth). codegen -> Rust `const STORY_BEATS`. `worldActionId`/`relatedIds`
// reference ids in other catalogs by value.
