...
use catalog::{
    ...
    STORY_BEATS, STRUCTURES, TILES, WORLD_ACTIONS,
};
...
const UI_ELEMENTS: &[UiElementDef] = &[
    ...
    UiElementDef {
        ...
        related_ids: &[
            ...
            FLAG_HERO_FORCED_RETURN_ACTIVE,
            FLAG_HERO_RECOVERING_AT_STUDIO,
        ],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
    ...
    UiElementDef {
        ...
        label: "Construction",
        related_ids: &[UI_PANEL_CONSTRUCTION],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
    ...
    UiElementDef {
        ...
        related_ids: &[UI_METRIC_HARMONICS_TIER],
        visibility: VisibilityDef {
            all_of: &[],
            any_of: &[VisibilityConditionDef::Always],
        },
