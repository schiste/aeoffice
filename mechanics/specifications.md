...
* GoodVibes:
    * GoodVibes is primarily generated by staffing the Fire Pit (crew efficiency applies).
...
* BadVibes:
    ...
    * Curve intent: exponential worsening with a plateau once `missing_bunks / crew_count >= 0.5` (exact formula TBD).
